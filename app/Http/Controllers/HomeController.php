...
class HomeController extends Controller
{
    ...
    {
        return view('index', [
            'drugs' => $this->drugRepository->getDrugsWithPagination($request), 
            'bannerDrugStores' => $this->userRepository->getBannerDrugStores(),
            'storesCount' => $this->drugRepository->countStores(), 
            'drugsCount' => $this->drugRepository->countDrugs(),
            'categories' => $this->categoryRepository->getAll(), 
            'visitors' => $this->drugSeenRepository->countAllVisits()
        ]);
    }
