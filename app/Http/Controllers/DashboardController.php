...
class DashboardController extends Controller
{
    ...
    {
        return view('templates.web-dashboard.index', [
            'cities' => $this->cityRepository->getAll(), 
            'drugs' => $this->drugRepository->getDrugs(),
            'drugStores' => $this->userRepository->getUsersWithPagination(),
            'stores'=>$this->userRepository->getAll(), 
